...
using static Ex_11_2_TPT_EntekhabReshteDA.Model;
        ...
        public string ConnectionString
        {
            get
            {
                if (connectionString == null)
                    connectionString = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["TPT_ConnectionString"].ConnectionString; 
